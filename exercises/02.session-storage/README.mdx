...
- `sameSite`: If set, the cookie will only be sent to the server if the request
  is originated from the same site. This is useful for preventing cross-site
...
This is why we are using the [cookie](https://www.npmjs.com/package/cookie) package
