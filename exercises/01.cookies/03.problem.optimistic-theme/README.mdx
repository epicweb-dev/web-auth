...
So let's improve this by applying optimistic UI to the theme selection. What we'll
...
It should be noted that all fetchers on the page which have been submitted
